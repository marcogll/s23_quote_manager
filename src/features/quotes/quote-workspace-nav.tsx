...
export type WorkspaceSection = "create" | "current" | "quotes" | "services" | "settings";
...
export const JsonImportPanel = ({ message, isError, onImport, onDownloadTemplate }: JsonImportPanelProps) => (
